...
- `--handlers-file FILENAME`: a file containing a list of handlers used in the
  specification.
- `--template-vars FILENAME`: a JSON file containing a list of additional
  variables to expand in the template.
...
monitoring using Copilot:
```sh
$ ogma ros --handlers-file filename --variable-file variables --variable-db ros-variable-db.json --target-dir ros_demo
```
...
```
$ ogma ros --template-dir my_template/ --handlers-file filename --variable-file variables --variable-db ros-variable-db.json --target-dir ros_demo
```
...
monitoring using Copilot:
```sh
$ ogma fprime --handlers-file filename --variable-file filename --variable-db fprime-variable-db.json --target-dir fprime_demo
```
...
```
$ ogma fprime --template-dir my_template/ --handlers-file filename --variable-file variables --variable-db fprime-variable-db.json --target-dir fprime_demo
```
